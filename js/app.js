...
if (tally <= 4) {
    var finalCount = alert('Nice try ' + username + ' you got ' + tally + ' out of 7 questions correct.');
} else if (tally > 4) {
    var finalCount = alert('Congratulations ' + username + ' you got ' + tally + ' out of 7 questions correct!');
}
